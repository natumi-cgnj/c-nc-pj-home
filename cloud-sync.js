(function () {
  ...
  const STATE_KEYS = [
    ...
    'kitchen_db', 'kitchen_project_categories_v1', 'meal_log_db', 'calorie_log_db', 'meal_companion_db',
  ...
  const PAGE_KEYS = {
    ...
    'meals.html': ['meal_log_db', 'calorie_log_db', 'meal_companion_db', 'recipe_salad_db', 'recipe_project_config', 'recipe_salad_db__world__cbi', 'recipe_project_config__world__cbi', 'omniverse_world_context'],
