...
test('CBI scenes expose the light STATUS entry and contact data is synced and backed up', () => {
  ...
  assert.match(index, /body\[data-world-id="cbi"\] \.cbi-contact-trigger\{display:block\}/);
