(function (global) {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      /* Wallet-era visual sync. Functional distinctions stay in the module renderers. */
      'body[data-cbi-work="1"]{background:#FAFAFA;color:#1a1a1a}',
      'body[data-cbi-work="1"] .top-bar h1{color:#999;font-size:13px;font-weight:500;letter-spacing:3px}',
      'body[data-cbi-work="1"] .content{padding-top:18px}',
      '.cbi-kicker{margin-bottom:4px;color:#bbb;font-size:9px;font-weight:400;letter-spacing:1px}',
      '.cbi-page-head{align-items:center;margin-bottom:17px}',
      '.cbi-page-title{color:#555;font-size:15px;font-weight:500;letter-spacing:.15px}',
      '.cbi-page-note{max-width:520px;margin-top:4px;color:#aaa;font-size:10px;line-height:1.55}',
      '.cbi-btn{padding:6px 10px;border-color:#e1e1de;border-radius:7px;background:#fff;color:#888;font-size:10px;font-weight:400}',
      '.cbi-btn.primary{border-color:#4f4b45;background:#4f4b45;color:#fff}',
      '.cbi-btn.gold{border-color:#ded6c7;background:#fff;color:#9a8052}',
      '.cbi-btn.danger{border-color:#eadedb;color:#b5796b}',
      '.cbi-card{margin-bottom:7px;padding:13px 14px;border-color:#f0f0f0;border-radius:11px;box-shadow:0 1px 4px rgba(0,0,0,.025)}',
      '.cbi-card-title{color:#444;font-size:12px;font-weight:500}',
      '.cbi-card-copy{margin-top:5px;color:#888;font-size:11px;line-height:1.65}',
      '.cbi-meta{gap:5px;margin-top:7px}',
      '.cbi-tag{padding:2px 6px;border-radius:5px;background:#f5f4f1;color:#999;font-size:8px;font-weight:400}',
      '.cbi-actions{gap:6px;margin-top:10px}',
      '.cbi-section{margin:19px 1px 8px;color:#bbb;font-size:9px;font-weight:400;letter-spacing:.8px}',
      '.cbi-scoreboard{gap:0;margin:0 0 17px;overflow:hidden;border:1px solid #eeeeec;border-radius:10px;background:#fff}',
      '.cbi-score{padding:9px 5px;border:0;border-right:1px solid #f1f1ef;border-bottom:1px solid #f1f1ef;border-radius:0;background:#fff}',
      '.cbi-score:nth-child(3n){border-right:0}',
      '.cbi-score:nth-last-child(-n+3){border-bottom:0}',
      '.cbi-score b{margin-bottom:3px;font-size:15px;font-weight:300}',
      '.cbi-score span{color:#aaa;font-size:8px}',
      '.cbi-case-file,.cbi-case-file.planned,.cbi-case-file.closed{position:relative;margin:8px 0;padding:14px 15px;border:1px solid #eeeeec;border-radius:11px;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,.025)}',
      '.cbi-case-file.closed{margin-top:8px;opacity:.62}',
      '.cbi-file-tab,.cbi-case-file.planned .cbi-file-tab,.cbi-case-file.closed .cbi-file-tab{position:static;display:block;width:max-content;height:auto;margin:0 0 7px;padding:0;border-radius:0;background:transparent;color:#aaa;font-size:8px;font-weight:400;letter-spacing:.6px}',
      '.cbi-case-file .cbi-card-title{font-family:inherit;letter-spacing:0}',
      '.cbi-progress-row,.cbi-case-file .cbi-progress-row{grid-template-columns:58px 1fr 40px;gap:7px;margin-top:7px}',
      '.cbi-progress-name{color:#888;font-size:9px}',
      '.cbi-track{height:3px;background:#eeeeec}',
      '.cbi-progress-num{color:#bbb;font-size:8px}',
      '.cbi-case-report{margin-top:9px;padding-top:8px;border-top-color:#f1f1ef;color:#aaa;font-size:9px}',
      '.cbi-empty{padding:42px 20px;border-color:#e2e2de;border-radius:10px;background:#fff;color:#bbb;font-size:11px}',
      '.cbi-commission-card{margin:7px 0 12px;padding:15px;border:1px solid #eeeeec;border-radius:11px;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,.025)}',
      '.cbi-commission-card:after{display:none}',
      '.cbi-commission-card .cbi-avatar{width:42px;height:42px}',
      '.cbi-commission-card .cbi-card-title{color:#444;font-size:13px}',
      '.cbi-commission-card .cbi-quote{margin-top:10px;padding:8px 10px;border:0;border-radius:8px;background:#faf9f7;box-shadow:none;color:#777;font-size:11px}',
      '.cbi-commission-card .cbi-card-copy{margin-top:9px;color:#777}',
      '.cbi-commission-summary{border-style:solid;background:#fff}',
      'body[data-cbi-work-tab="drop"] .cbi-page-title,body[data-cbi-work-tab="habits"] .cbi-page-title,body[data-cbi-work-tab="todo"] .cbi-page-title{color:#555}',
      '@media(min-width:700px){.cbi-score:nth-child(3n){border-right:1px solid #f1f1ef}.cbi-score:nth-child(6n){border-right:0}.cbi-score{border-bottom:0}}'
    ].join('');
